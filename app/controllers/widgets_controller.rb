  ...
  private
    ...
    def set_flashes
      if params[:subscribed] == 'true'
        ...
        flash.now[:notice] = 'Your Unlimited Plan is now active!'
      end
    end
    ...
    def widget_params
      params.require(:widget).permit(:name, :welcome_message, :thank_you_message, :background_color, :text_color, :shape, :location, :enabled, :avatar)
    end
end
